...
- `GroupBox` “Receta” (**habilitar solo si Estado=ATENDIDA**; si está deshabilitado, añadir `AccessibleDescription` con el mensaje: “Las recetas solo se capturan para citas atendidas”):
  - `TextBox` Diagnóstico.
  - `TextBox` Medicamento.
  - `TextBox` Dosis.
- Botones CRUD.
