...
partial class FrmSuperAdminDashboard
{
    ...
    private SplitContainer opcionesSplit;
    private TabControl tabOpcionesInternas;
    private TabPage tabAuditoria;
    private TabPage tabRolesPermisos;
    private DataGridView dgvAuditoria;
    private GroupBox grpFiltrosAuditoria;
    private TableLayoutPanel filtrosAuditoriaLayout;
    private DateTimePicker dtpAuditoriaDesde;
    private DateTimePicker dtpAuditoriaHasta;
    private TextBox txtAuditoriaUsuario;
    private ComboBox cboAuditoriaAccion;
    private Button btnAuditoriaFiltrar;

    private TableLayoutPanel rolesLayout;
    private DataGridView dgvRoles;
    private DataGridView dgvUsuariosRoles;
    private CheckedListBox clbPermisos;
    private TextBox txtMascaraHex;
    private FlowLayoutPanel rolesButtons;
    private Button btnAsignarRol;
    private Button btnQuitarRol;
    private Button btnGuardarPermisos;

    private Panel panelAccionesCriticas;
    private FlowLayoutPanel accionesLayout;
    private Button btnVaciarTablas;
    private Button btnEjecutarTrigger;
    private Button btnGenerarRespaldo;
    ...
    private void InitializeComponent()
    {
        ...
        opcionesSplit = new SplitContainer();
        tabOpcionesInternas = new TabControl();
        tabAuditoria = new TabPage();
        tabRolesPermisos = new TabPage();
        dgvAuditoria = new DataGridView();
        grpFiltrosAuditoria = new GroupBox();
        filtrosAuditoriaLayout = new TableLayoutPanel();
        dtpAuditoriaDesde = new DateTimePicker();
        dtpAuditoriaHasta = new DateTimePicker();
        txtAuditoriaUsuario = new TextBox();
        cboAuditoriaAccion = new ComboBox();
        btnAuditoriaFiltrar = new Button();

        rolesLayout = new TableLayoutPanel();
        dgvRoles = new DataGridView();
        dgvUsuariosRoles = new DataGridView();
        clbPermisos = new CheckedListBox();
        txtMascaraHex = new TextBox();
        rolesButtons = new FlowLayoutPanel();
        btnAsignarRol = new Button();
        btnQuitarRol = new Button();
        btnGuardarPermisos = new Button();

        panelAccionesCriticas = new Panel();
        accionesLayout = new FlowLayoutPanel();
        btnVaciarTablas = new Button();
        btnEjecutarTrigger = new Button();
        btnGenerarRespaldo = new Button();
        ...
        ((System.ComponentModel.ISupportInitialize)opcionesSplit).BeginInit();
        opcionesSplit.Panel1.SuspendLayout();
        opcionesSplit.Panel2.SuspendLayout();
        opcionesSplit.SuspendLayout();
        tabOpcionesInternas.SuspendLayout();
        tabAuditoria.SuspendLayout();
        tabRolesPermisos.SuspendLayout();
        ((System.ComponentModel.ISupportInitialize)dgvAuditoria).BeginInit();
        grpFiltrosAuditoria.SuspendLayout();
        filtrosAuditoriaLayout.SuspendLayout();
        rolesLayout.SuspendLayout();
        ((System.ComponentModel.ISupportInitialize)dgvRoles).BeginInit();
        ((System.ComponentModel.ISupportInitialize)dgvUsuariosRoles).BeginInit();
        rolesButtons.SuspendLayout();
        panelAccionesCriticas.SuspendLayout();
        accionesLayout.SuspendLayout();
        SuspendLayout();
        ...
        btnNavOpciones.Text = "Opciones Avanzadas";
        btnNavOpciones.Width = 180;
        ...
        tabMain.TabPages.Add(tabOpciones);
        ...
        tabOpciones.Text = "Opciones Avanzadas";
        tabOpciones.Controls.Add(opcionesSplit);

        opcionesSplit.Dock = DockStyle.Fill;
        opcionesSplit.Orientation = Orientation.Horizontal;
        opcionesSplit.SplitterDistance = 360;
        opcionesSplit.Panel1.Controls.Add(tabOpcionesInternas);
        opcionesSplit.Panel2.Controls.Add(panelAccionesCriticas);

        tabOpcionesInternas.Dock = DockStyle.Fill;
        tabOpcionesInternas.TabPages.Add(tabAuditoria);
        tabOpcionesInternas.TabPages.Add(tabRolesPermisos);

        tabAuditoria.Text = "Auditoría";
        tabAuditoria.Controls.Add(dgvAuditoria);
        tabAuditoria.Controls.Add(grpFiltrosAuditoria);

        grpFiltrosAuditoria.Dock = DockStyle.Top;
        grpFiltrosAuditoria.Height = 120;
        grpFiltrosAuditoria.Text = "Filtros";
        grpFiltrosAuditoria.Controls.Add(filtrosAuditoriaLayout);

        filtrosAuditoriaLayout.ColumnCount = 4;
        filtrosAuditoriaLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
        filtrosAuditoriaLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
        filtrosAuditoriaLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
        filtrosAuditoriaLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 25F));
        filtrosAuditoriaLayout.Dock = DockStyle.Fill;
        filtrosAuditoriaLayout.RowCount = 3;
        filtrosAuditoriaLayout.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        filtrosAuditoriaLayout.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        filtrosAuditoriaLayout.RowStyles.Add(new RowStyle(SizeType.AutoSize));
        filtrosAuditoriaLayout.Controls.Add(new Label { Text = "Desde", AutoSize = true }, 0, 0);
        filtrosAuditoriaLayout.Controls.Add(dtpAuditoriaDesde, 1, 0);
        filtrosAuditoriaLayout.Controls.Add(new Label { Text = "Hasta", AutoSize = true }, 2, 0);
        filtrosAuditoriaLayout.Controls.Add(dtpAuditoriaHasta, 3, 0);
        filtrosAuditoriaLayout.Controls.Add(new Label { Text = "Usuario", AutoSize = true }, 0, 1);
        filtrosAuditoriaLayout.Controls.Add(txtAuditoriaUsuario, 1, 1);
        filtrosAuditoriaLayout.Controls.Add(new Label { Text = "Acción", AutoSize = true }, 2, 1);
        filtrosAuditoriaLayout.Controls.Add(cboAuditoriaAccion, 3, 1);
        filtrosAuditoriaLayout.Controls.Add(btnAuditoriaFiltrar, 3, 2);

        dtpAuditoriaDesde.Dock = DockStyle.Fill;
        dtpAuditoriaHasta.Dock = DockStyle.Fill;
        txtAuditoriaUsuario.Dock = DockStyle.Fill;
        cboAuditoriaAccion.Dock = DockStyle.Fill;
        cboAuditoriaAccion.DropDownStyle = ComboBoxStyle.DropDownList;
        cboAuditoriaAccion.Items.AddRange(new object[] { "INSERT", "UPDATE", "DELETE" });
        btnAuditoriaFiltrar.Text = "Filtrar";
        btnAuditoriaFiltrar.Anchor = AnchorStyles.Right;

        dgvAuditoria.Dock = DockStyle.Fill;
        dgvAuditoria.BackgroundColor = SystemColors.Window;
        dgvAuditoria.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;

        tabRolesPermisos.Text = "Roles y Permisos";
        tabRolesPermisos.Controls.Add(rolesLayout);

        rolesLayout.ColumnCount = 2;
        rolesLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 60F));
        rolesLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 40F));
        rolesLayout.Dock = DockStyle.Fill;
        rolesLayout.RowCount = 2;
        rolesLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 70F));
        rolesLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 30F));
        rolesLayout.Controls.Add(dgvRoles, 0, 0);
        rolesLayout.Controls.Add(dgvUsuariosRoles, 0, 1);
        rolesLayout.Controls.Add(clbPermisos, 1, 0);
        rolesLayout.Controls.Add(rolesButtons, 1, 1);

        dgvRoles.Dock = DockStyle.Fill;
        dgvRoles.BackgroundColor = SystemColors.Window;
        dgvRoles.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;

        dgvUsuariosRoles.Dock = DockStyle.Fill;
        dgvUsuariosRoles.BackgroundColor = SystemColors.Window;
        dgvUsuariosRoles.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;

        clbPermisos.Dock = DockStyle.Fill;

        rolesButtons.Dock = DockStyle.Fill;
        rolesButtons.FlowDirection = FlowDirection.TopDown;
        rolesButtons.Controls.Add(new Label { Text = "Máscara hex", AutoSize = true });
        rolesButtons.Controls.Add(txtMascaraHex);
        rolesButtons.Controls.Add(btnAsignarRol);
        rolesButtons.Controls.Add(btnQuitarRol);
        rolesButtons.Controls.Add(btnGuardarPermisos);

        txtMascaraHex.Width = 120;
        btnAsignarRol.Text = "Asignar rol";
        btnQuitarRol.Text = "Quitar rol";
        btnGuardarPermisos.Text = "Guardar permisos";

        panelAccionesCriticas.Dock = DockStyle.Fill;
        panelAccionesCriticas.Padding = new Padding(12);
        panelAccionesCriticas.Controls.Add(accionesLayout);

        accionesLayout.Dock = DockStyle.Fill;
        accionesLayout.FlowDirection = FlowDirection.LeftToRight;
        accionesLayout.WrapContents = true;
        accionesLayout.Controls.Add(btnVaciarTablas);
        accionesLayout.Controls.Add(btnEjecutarTrigger);
        accionesLayout.Controls.Add(btnGenerarRespaldo);
        accionesLayout.Controls.Add(lblAdvertencia);

        btnVaciarTablas.Text = "Vaciar tablas";
        btnEjecutarTrigger.Text = "Ejecutar trigger manual";
        btnGenerarRespaldo.Text = "Generar respaldo";
        lblAdvertencia.AutoSize = true;
        lblAdvertencia.Text = "Acciones críticas requieren confirmación";
        lblAdvertencia.Margin = new Padding(12, 8, 3, 3);
        ...
        tabOpciones.ResumeLayout(false);
        ...
        opcionesSplit.Panel1.ResumeLayout(false);
        opcionesSplit.Panel2.ResumeLayout(false);
        ((System.ComponentModel.ISupportInitialize)opcionesSplit).EndInit();
        opcionesSplit.ResumeLayout(false);
        tabOpcionesInternas.ResumeLayout(false);
        tabAuditoria.ResumeLayout(false);
        tabRolesPermisos.ResumeLayout(false);
        ((System.ComponentModel.ISupportInitialize)dgvAuditoria).EndInit();
        grpFiltrosAuditoria.ResumeLayout(false);
        filtrosAuditoriaLayout.ResumeLayout(false);
        filtrosAuditoriaLayout.PerformLayout();
        rolesLayout.ResumeLayout(false);
        ((System.ComponentModel.ISupportInitialize)dgvRoles).EndInit();
        ((System.ComponentModel.ISupportInitialize)dgvUsuariosRoles).EndInit();
        rolesButtons.ResumeLayout(false);
        rolesButtons.PerformLayout();
        panelAccionesCriticas.ResumeLayout(false);
        accionesLayout.ResumeLayout(false);
        accionesLayout.PerformLayout();
        ResumeLayout(false);
    }
}
